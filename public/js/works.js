...
`,
  ...
  portfolio: {
    ...
    detail: `
      <p>フリーランスエンジニアとして活動するために作成。</p>
      <p>
      基本的なデザインは<a href="https://colorlib.com/" target="_blank">Colorlib</a>にて提供されているテンプレートに沿いつつ、実績欄の開発に注力。<br>
      各実績をBootstrapのcardを用いて表現し、<a href="https://muuri.dev/" target="_blank">Muuriライブラリ</a>によるグリッドシステムで一覧性を高くすると同時に、それぞれタグを複数指定できるようにして、タグによる絞り込み検索を可能としています。<br>
      さらに、後から簡単に実績やタグを追加/削除/細かい調整をできるようにコードを工夫しています。<br>      
      </p>
      <p>
      初めて今流行りのVue.jsを用いて作った作品でもあります。<br>
      当然ではありますが、素のjs/jQueryだけでゴリゴリ処理を書くより圧倒的に可読性・保守性が高いコードなって感動です。
      </p>
      <p class="real-intention">ちなみにトップの写真は2万円以上掛けて人生で初めてお化粧とヘアセット込みでスタジオで撮影しましたが、どんなに冴えない容貌でもなんかそれっぽくしてくれる今の技術に驚きでした。</p>
      <ul>
        <li>
        Webページテンプレート提供
          <ul>
        ...
        アイコン提供
          <ul>
            ...
            <li>
               ...
               Under <a href="http://creativecommons.org/licenses/by/3.0/" target="_blank">CC</a>: <a data-file="005-zoom-in"
                                          href="https://www.flaticon.com/authors/kiranshastry" target="_blank">Kiranshastry</a>,
               <a data-file="002-internet" href="http://www.freepik.com" target="_blank">Freepik</a>,
               <a data-file="003-code" href="https://www.flaticon.com/authors/pixel-perfect" target="_blank">Pixel perfect</a>, <a data-file="004-brain"href="https://www.flaticon.com/authors/smashicons" target="_blank">Smashicons</a>
               </p>
            </li>
          </ul>
        </li>
  ...
  minecraft_plugins: {
    ...
    detail: `
      ...
      <p>滅茶苦茶な実装ですが、作品を通して心から楽しみながらプログラミングの学習ができたという意味でも良い経験でした。</p>
      <p class="real-intention">正直今見ると色んな意味でここに書くのが若干恥ずかしいレベルの作品ですが、実績欄を水増しするために気にしません（）</p>
      <ul>
        <li>
